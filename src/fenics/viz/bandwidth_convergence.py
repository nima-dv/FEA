...
RUN
  ./run.ps1 python3 viz/bandwidth_convergence.py
"""
...
FW = Path(__file__).resolve().parents[1] / "results" / "ili_forward"
KW = Path(__file__).resolve().parents[1] / "results" / "kwave_cases"
