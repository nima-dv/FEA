...
RUN
  ./run.ps1 python3 presentation/scripts/c4_staircase.py \
      --conforming presentation/data/ili_forward/channel_data_c4_conforming_p20deg.npz \
      --staircase  presentation/data/ili_forward/channel_data_c4_staircase_p20deg.npz
"""
