r"""Body copy for the decision brief. Built by presentation/scripts/build_artifacts.py.
...
<footer>
  ...
  dossier. Everything on this page reproduces from committed code: <code>src/backend/</code> in
